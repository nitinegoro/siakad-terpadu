   ...
   <body>
    ...
    <div class="wrapper">
      ...
      <table width="80%" align="center" style="margin-bottom: 5px; text-align:left">
          <tr>
              <th width="90">Kode Dosen </th> <td width="10" style="text-align:center;">:</td>
              <td><?php echo $this->session->userdata('account')->lecturer_code; ?></td>
              <td width="100"></td>
              <th width="90">Kode MK </th>  <td width="10" style="text-align:center;">:</td>
              <td><?php echo $jadwal->course_code; ?></td>
          </tr>
          <tr>
              <th width="90">Nama Dosen</th> <td width="10" style="text-align:center;">:</td>
              <td><?php echo $this->session->userdata('account')->name; ?></td>
              <td width="100"></td>
              <th width="90">Mata Kuliah </th>  <td width="10" style="text-align:center;">:</td>
              <td><?php echo $jadwal->course_name; ?></td>
          </tr>
          <tr>
              <th width="90">Semester </th> <td width="10" style="text-align:center;">:</td>
              <td><?php echo strtoupper($jadwal->semester); ?></td>
              <td width="100"></td>
              <th width="90">SKS </th>  <td width="10" style="text-align:center;">:</td>
          ...
          <tr>
              ...
              <td width="100"></td>
              <th width="90">Kelas </th>  <td width="10" style="text-align:center;">:</td>
              <td><?php echo $jadwal->class_name; ?> - <?php echo $jadwal->session_start."-".$jadwal->session_end; ?></td>
          </tr>
      </table>
        ...
        <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="text-center"><?php echo $value->npm; ?></td>
            ...
            <table style="padding-top: 10px; width: 50%; float: left; border: none;">
              <tr>
                 ...
                 <td style="width: 50%; text-align: left; font-weight: normal;">
                  <p><small>
                    <strong><i>NB :</i></strong><br>Data Nilai ini dicetak dengan layanan sistem dan, dinyatakan sah apabila sudah ditanda tangani oleh Ketua Program Studi dan dicap stempel STIE Pertiba di Bagian Akademik.
                  </small> <br><small><i>Dicetak pada <?php echo tgl_indo(date('Y-m-d')).", ".date('H:i A') ?></i></small></p>
                 </td> 
              </tr>
           </table>
