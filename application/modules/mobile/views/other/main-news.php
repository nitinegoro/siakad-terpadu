        ...
        <div class="col s12" ng-repeat="item in results">
            <div class="card horizontal">
                <div class="card-image">
                    <img src="https://lorempixel.com/90/90/business/6" alt="Images stie pertiba" width="90" height="90">
                </div>
                <div class="card-stacked">
                    <div class="card-content">
                        <a href="" class="news-link black-text">{{item.title}}
